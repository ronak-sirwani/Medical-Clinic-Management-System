...
<div class="container1" >
   ...
   <!-- <div class="form-group">
    ...
    <?php 
     ...
     $sql1 = "SELECT prescription.*,appointment.apt_name,appointment.apt_email,appointment.p_id,doctor.d_name,appointment.apt_date FROM prescription,appointment,doctor WHERE prescription.apt_id=appointment.apt_id AND appointment.d_id=doctor.d_id AND appointment.apt_id = $apt_id";
