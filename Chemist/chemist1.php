...
<div class="table-responsive">
  <table class="table">
    <thead class="thead-light">
      <tr>
        <th class="text-white bg-dark">Sr.No</th>
    ...
    <tbody id="search">
<?php 
//$sql1 = "SELECT prescription.*,appointment.apt_name,doctor.d_name,appointment.apt_date FROM prescription,appointment,doctor WHERE prescription.apt_id=appointment.apt_id AND appointment.d_id=doctor.d_id";
//$sql1 ="SELECT prescription.*,appointment.apt_name,doctor.d_name,appointment.apt_date FROM prescription,appointment,doctor WHERE prescription.apt_id=appointment.apt_id AND appointment.d_id=doctor.d_id ORDER BY appointment.apt_date DESC";
$sql1="SELECT prescription.*,appointment.apt_name,appointment.apt_email,appointment.apt_mobile,doctor.d_name,appointment.apt_date FROM prescription,appointment,doctor WHERE prescription.apt_id=appointment.apt_id AND appointment.d_id=doctor.d_id ORDER BY appointment.apt_date DESC";
...
$index = 1; 
  while($row1 = mysqli_fetch_assoc($result1))
  {
   ...
   <!-- <td><?php// echo $row1['apt_id'];?></td>-->
      <td><?php echo $row1['apt_name'];?></td>
      <td><?php echo $row1['apt_email'];?></td>
      <td><?php echo $row1['apt_mobile'];?></td>

       <td><?php echo $row1['d_name'];?></td>
       <td><?php echo $row1['apt_date'];?></td>

       <td><a href = "allPrescriptions1.php?apt_id=<?php echo $row1['apt_id']; ?>">View</a></td>
</tr>
<?php
   // echo "<br>";
   $y = preg_split('#/#',$x);
