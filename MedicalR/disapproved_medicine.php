...
<head>
	...
	<script src="bootstrap-4.5.3-dist\DataTables-1.10.24\js\am.js"></script>
</head>
<body>
	<?php
	include '../config.php';
	...
	$sql = "SELECT m_name,m_status FROM medicine WHERE mr_id=$tempId AND m_status=2";
	$result = $mysqli->query($sql);
	$mysqli->close();
	?>

	<h2 class="text-center mb-4">Total Disapproved Medicines</h2>
	<table id="amtable" class="table table-striped table-bordered table-sm" width="95%">
		<thead>
			<tr>
